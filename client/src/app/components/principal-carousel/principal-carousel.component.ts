import { ChangeDetectorRef, Component, NgZone, ViewChild, OnInit, Input } from "@angular/core";
...
@Component({
  selector: 'app-principal-carousel',
  templateUrl: './principal-carousel.component.html',
  styleUrls: ['./principal-carousel.component.css']
})
export class PrincipalCarouselComponent implements OnInit{
